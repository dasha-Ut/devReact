        ...
        <ChapterWrapper title="Rendering process" subtitle="🌲 🆚 🌲 ➡️ 🌳">
            <div className={classes.container}>
                <div style={getSectionStyle(2)}>
                    ...
                    <ColoredBlock>
                        New render has been triggered (because of some change in the state of the
                        app). React calls the root component function. Children component function
                        will be called recursively.
                    </ColoredBlock>
                    <Emoji>⬇️</Emoji>
                    <ColoredBlock>
                        New Virtual DOM tree is created now. It consists of React Elements -
                        lightweight javascript object which sits in memory and stores representation
                        of a component. They have no direct connection to the real DOM elements.
                    </ColoredBlock>
                    <Emoji>⬇️</Emoji>
                    <ColoredBlock>
                        New VDOM now should be compared to the old one (if it exists, of course).
                        Calculated diff will be applied to the real DOM.
                    </ColoredBlock>
                    <div className={classes.bottomLabel}>
                        Virtual DOM is a tree data structure of lightweight React Element objects.
                        React can generate thousands of React Elements on each render with a great
                        performance.
                    </div>
                </div>
